...
class Audio extends React.Component {
  ...
  handlePlay = () => {
    ...
    let frequency = 440.0 // will be changed to this.props.selecedNote(or w/e we want to call it) later  for now we're hard coding the frequency for testing purposes.
